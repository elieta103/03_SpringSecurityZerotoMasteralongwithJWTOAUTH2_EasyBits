...
public class ProjectSecurityConfig {
    ...
    //Implementacion de JdbcUserDetailsManager, requiere tablas : users y authorities
    // Solo una de las 2 implementaciones :
    // public class EazyBankUserDetails implements UserDetailsService OR  public UserDetailsService userDetailsService(DataSource dataSource)
    // Si estan las 2 lanza exception :
